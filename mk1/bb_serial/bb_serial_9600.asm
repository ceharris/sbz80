...
bb_putc_10:
		...
		; before first bit
         	; cycles = 7 + 40*18 + 3*4 + 4 + 8 + 4 + 11 = 766
         	; time = 766 cycles * 135.633 nsec/cycle = 103.9 usec
         	; before remaining bits
         	; cycles = 7 + 39*18 + 3*4 + 4 + 4 + 10 + 4 + 8 + 4 + 11 = 766
         	; time = 766 cycles * 135.633 nsec/cycle = 103.9 usec
...
bb_putc_15:
		...
		; before stop bit 
		; cycles = 7 + 39*18 + 3*4 + 4 + 10 + 2*4 + 4 + 4 + 4 + 11 = 766  
         	; time = 766 cycles * 135.633 nsec/cycle = 103.9 usec
 ...
 bb_putc_25:
 		...
 		nop			; [T=4]
 		; after stop bit
 		; cycles = 7 + 42*18 + 4 = 767
         	; time = 767 cycles * 135.633 nsec/cycle = 104.0 usec
