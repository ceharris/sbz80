...
ACIA_CTRL       equ ACIA_PORT + 0
ACIA_DATA       equ ACIA_PORT + 1
...
ACIA_RTS_DTI    equ 0 << 5
ACIA_RTS_ETI    equ 1 << 5
ACIA_NOT_RTS 	equ 2 << 5
ACIA_RTS_BRK    equ 3 << 5
...
ACIA_READY	equ ACIA_DIV64 | ACIA_8N1 | ACIA_RTS_DTI | ACIA_ERI
ACIA_NOT_READY	equ ACIA_DIV64 | ACIA_8N1 | ACIA_NOT_RTS | ACIA_ERI

RX_BUFFER_SIZE	equ 128
RX_BUFFER_LO	equ 16
RX_BUFFER_HI	equ RX_BUFFER_SIZE - RX_BUFFER_LO


RX_READY	equ 1 << 6
TX_READY	equ 1 << 7

FLUSH_DELAY	equ 10			; flush delay in milliseconds
